...
public class GameMap {
	...
	private void inHole(){
		...
		if(num_H==0||num_H==1){
			bamH= DashSurfaceView.screenH-bam_under.getHeight()*2/3;
		}
		if(num_H==2){
			bamH= DashSurfaceView.screenH-bam_under.getHeight()*4/5;
		}
		if(num_H==3){
			bamH= DashSurfaceView.screenH-bam_under.getHeight()/2;
		}
		//坑宽
