...
public class Tools {
    ...
    //游戏中屏幕下移触发点Y坐标常量
    public static final int IS_BG_DOWN = DashSurfaceView.screenH / 2;
    //桥的类型
    ...
    //忍者出现的x坐标
    public static final int NINJA_X = DashSurfaceView.screenW / 8;
    //忍者上下移动的速度
    public static final int NINJA_SPEED = DashSurfaceView.screenH / 35;
    //忍者的相关参数-----------------------------------------------------------------------------------------------------
