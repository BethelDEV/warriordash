...
public class Bullet {
	...
	public void onDraw(Canvas canvas, Paint paint) {
		if (bulletType == Tools.BULLETPLAYERWUDIAFTER) {
			for (int i = 0; i <= DashSurfaceView.screenH/bmpBullet.getHeight(); i++) {
	...
	public void logic() {
		...
		case Tools.BULLETPLAYER:
			...
			if (bulletX >= DashSurfaceView.screenW + 40) {
				bulletIsDead = true;
			}
			break;
	...
	public int getBmpH() {
		return bulletType==Tools.BULLETPLAYERWUDIAFTER? DashSurfaceView.screenH:bmpH;
	}
